...
contract LiquidationOperator is IUniswapV2Callee {
    ...
    function uniswapV2Call(
        ...
        console.log("uniswapV2Pair       %s", address(uniswapV2Pair_WBTC_USDT));
        console.log("         WBTC       %s", reserve_WBTC_Pool3);
        console.log("         USDT       %s", reserve_USDT_Pool3);
        console.log("");
        console.log("uniswapV2Pair       %s", address(uniswapV2Pair_WBTC_WETH));
        console.log("         WBTC       %s", reserve_WBTC_Pool2);
        console.log("         WETH       %s", reserve_WETH_Pool2);
        console.log("");
